                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-4 col-form-label text-md-right">{{ __('Fisrt Name') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="userrole" type="text" class="form-control @error('userrole') is-invalid @enderror" name="userrole" value="{{ old('userrole') }}" required autocomplete="userrole" autofocus>
